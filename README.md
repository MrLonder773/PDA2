...
Также для изучения структуры можно изучить Bluetooth класс. Например можно вручную включать и выключать Bluetooth с помощью функций к классе. Реализация прилогается:
```
