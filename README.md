...
PDA2 - устройство на основе ESP32 S3, автор старается создать сообственное КПК подобное устройство. Сейчас устройство переживает сильные изменения, текущий README и все изображения могут быстро терять актуальность.
